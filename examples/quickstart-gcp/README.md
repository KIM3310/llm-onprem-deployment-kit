...
Before running this quickstart, architecture the Google Cloud cost calculator for the selected region, GPU node, standard nodes, NAT, Secret Manager, and Private Service Connect. Keep the environment short-lived unless a operator-approved pilot scope requires longer testing.
