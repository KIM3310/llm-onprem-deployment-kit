...
Before running this quickstart, review the AWS cloud cost calculator for the selected region, GPU node, standard nodes, NAT Gateway, Secrets Manager, and VPC Endpoints. Keep the environment short-lived unless an operator-approved pilot scope requires longer testing.
