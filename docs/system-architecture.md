# System Architecture - llm-onprem-deployment-kit
...
| Primary stack | Terraform infrastructure modules, GitHub Actions validation |
| Architecture axes | cloud architecture, AI engineering, reliability, security, operator experience |

Repository-local proof surface for agent runtime reliability and AI workflow orchestration, backed by Terraform infrastructure modules, GitHub Actions validation.
...
flowchart LR
    ...
    Surface --> Runtime["Runtime boundary: Terraform infrastructure modules, GitHub Actions validation"]
...
| Runtime | Terraform infrastructure modules, GitHub Actions validation | Keep runtime adapters bounded by environment configuration and documented fallbacks. |
