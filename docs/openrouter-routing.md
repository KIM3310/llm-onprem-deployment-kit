...
| Lane | Model | Purpose |
|---|---|---|
| Primary | `openai/gpt-5.2` | Private LLM deployment planning, risk reviews, and upgrade runbook drafting. |
| Fallback | `anthropic/claude-sonnet-4.6` | Higher reliability or alternate-provider path when the primary model is unavailable. |
...
OPENROUTER_HTTP_REFERER=https://llm-onprem-deployment-kit.pages.dev
OPENROUTER_APP_TITLE=llm-onprem-deployment-kit
```
