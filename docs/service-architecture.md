...
- **Lane:** Private LLM deployment readiness
- **Primary buyer:** Regulated teams assessing private or hybrid LLM deployment
- **First motion:** Readiness review and reference-architecture mapping

## Recommended Architecture

Docs-first architecture repo; private pilot uses buyer cloud/VPC, containerized services, vector store, audit logs, and model gateway.
...
- buyer cloud credentials via least privilege
- model provider or on-prem endpoint credentials
- registry credentials

## Cost and Risk Controls

- no direct production access without runbook
- network egress review
- model and data residency documented
