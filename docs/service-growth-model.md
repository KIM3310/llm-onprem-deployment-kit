# Service Growth Model - llm-onprem-deployment-kit
...
| Field | Decision |
|---|---|
| Service type | Private LLM deployment readiness |
| Primary reader or buyer | Regulated teams assessing private or hybrid LLM deployment. |
| Wedge | Readiness review and reference-architecture mapping. |
