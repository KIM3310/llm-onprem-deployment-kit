...
- URL: https://llm-onprem-deployment-kit.pages.dev/
...
On-prem LLM deployment kit for private AI runtime evaluation, controls, and implementation planning.
...
| Runtime stack | Makefile automation |
